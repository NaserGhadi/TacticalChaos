...
public class TristanaAbility extends Ability {
    public TristanaAbility(){
        this.abilityName = "TristanaAbility";
        this.heroID = 40;
    }
    @Override
