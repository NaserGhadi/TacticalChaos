...
public class LissandraAbility extends Ability {
    public LissandraAbility(){
        this.abilityName = "LissandraAbility";
        this.heroID = 24;
    }
    @Override
